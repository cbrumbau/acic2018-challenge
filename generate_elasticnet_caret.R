#!/usr/bin/env Rscript
#
# Rscript generate_elasticnet_caret.R --folds --include --merge imputations_folder output_folder
# This R script generates elasticnet linear regression models from an imputations folder to an output folder as R object files.
#
